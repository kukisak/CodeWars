...
class OrderTest {
    ...
    public void test1Clever() {
        assertThat(Order.orderClever("is2 Thi1s T4est 3a"), equalTo("Thi1s is2 3a T4est"));
    }

    @Test
    public void test2Clever() {
        assertThat(Order.orderClever("4of Fo1r pe6ople g3ood th5e the2"), equalTo("Fo1r the2 g3ood 4of th5e pe6ople"));
    }

    @Test
    public void test3Clever() {
        assertThat("Empty input should return empty string", Order.orderClever(""), equalTo(""));
    }
